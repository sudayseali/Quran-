...
import { X, Home, BookOpen, Settings, Globe, Share2, Heart, Compass, Clock, Calendar, Moon, Sun } from 'lucide-react';
...
export const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose, onNavigate, onOpenLanguage, isDarkMode, toggleDarkMode }) => {
